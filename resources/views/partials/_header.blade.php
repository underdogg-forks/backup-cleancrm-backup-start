    ...
    <ul class="nav navbar-nav ml-auto d-md-down-none">
        <li class="nav-item dropdown px-3">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="{{ route('companyProfiles.index') }}">@lang('cleancrm.company_profiles')</a>
                ...
                <a class="dropdown-item" href="{{ route('paymentMethods.index') }}">@lang('cleancrm.payment_methods')</a>
