...
class WidgetController extends Controller
{
    public function renderPartial()
    {
        ...
        if (request()->has('widgetInvoiceSummaryDashboardTotalsFromDate')) {
            Setting::saveByKey('widgetInvoiceSummaryDashboardTotalsFromDate',
                request('widgetInvoiceSummaryDashboardTotalsFromDate'));
        }

        if (request()->has('widgetInvoiceSummaryDashboardTotalsToDate')) {
            Setting::saveByKey('widgetInvoiceSummaryDashboardTotalsToDate',
                request('widgetInvoiceSummaryDashboardTotalsToDate'));
        }
