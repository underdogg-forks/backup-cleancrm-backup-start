...
Route::group(['middleware' => ['web', 'auth.admin'], 'namespace' => 'IP\Modules\CustomFields\Controllers'],
    function () {
        ...
        Route::get('custom_fields/{id}/delete',
            ['uses' => 'CustomFieldController@delete', 'as' => 'customFields.delete']);
