...
Route::group(['middleware' => ['web', 'auth.admin'], 'namespace' => 'IP\Modules\CompanyProfiles\Controllers'],
    function () {
...
Route::get('company_profiles/{id}/logo',
    ['uses' => 'IP\Modules\CompanyProfiles\Controllers\LogoController@logo', 'as' => 'companyProfiles.logo']);